...
#define PK_PL_BS (BM_OPK_BS - (sizeof(BM_MSG_HDR) + sizeof(BM_OBJECT))) // PAYLOAD of the pubkey object
...
#define GET_OBJ_PL(t,o) (t)(((ULONG_PTR)&o->payload) + sizeof(BM_OBJECT));
...
#define ZERO_(a,b) RtlSecureZeroMemory(a, b); //Utils::zero_mem(a, b);
#define ZEROw_(a,b) ZERO_(a,b * sizeof(WCHAR));

#define ALLOC_(a) Memory::alloc(a);//VirtualAlloc(0, a, MEM_COMMIT | MEM_RESERVE, PAGE_READWRITE); //malloc(a);//
#define ALLOCw_(a) ALLOC_(a * sizeof(WCHAR))

#define FREE_(a,b) Memory::free(a,b);//VirtualFree(a, 0, MEM_RELEASE);//free(a);//
